{
  ...
  spec: {
    ...
    networking: {
      ...
      ingress: {
        '#from':: d.obj(help='"List of peers which should be able to access the targets in TargetGroup.\\nAt least one NetworkingPeer should be specified."'),
        from: {
          '#ipBlock':: d.obj(help='"IPBlock defines an IPBlock peer.\\nIf specified, none of the other fields can be set."'),
          ipBlock: {
            '#withCidr':: d.fn(help='"CIDR is the network CIDR.\\nBoth IPV4 or IPV6 CIDR are accepted."', args=[d.arg(name='cidr', type=d.T.string)]),
            withCidr(cidr): { ipBlock+: { cidr: cidr } },
          },
          '#securityGroup':: d.obj(help='"SecurityGroup defines a SecurityGroup peer.\\nIf specified, none of the other fields can be set."'),
          securityGroup: {
        ...
        '#ports':: d.obj(help='"List of ports which should be made accessible on the targets in TargetGroup.\\nIf ports is empty or unspecified, it defaults to all ports with TCP."'),
        ports: {
          '#withPort':: d.fn(help='"The port which traffic must match.\\nWhen NodePort endpoints(instance TargetType) is used, this must be a numerical port.\\nWhen Port endpoints(ip TargetType) is used, this can be either numerical or named port on pods.\\nif port is unspecified, it defaults to all ports."', args=[d.arg(name='port', type=d.T.any)]),
          withPort(port): { port: port },
          '#withProtocol':: d.fn(help='"The protocol which traffic must match.\\nIf protocol is unspecified, it defaults to TCP."', args=[d.arg(name='protocol', type=d.T.string)]),
          withProtocol(protocol): { protocol: protocol },
        },
        '#withFrom':: d.fn(help='"List of peers which should be able to access the targets in TargetGroup.\\nAt least one NetworkingPeer should be specified."', args=[d.arg(name='from', type=d.T.array)]),
        withFrom(from): { from: if std.isArray(v=from) then from else [from] },
        '#withFromMixin':: d.fn(help='"List of peers which should be able to access the targets in TargetGroup.\\nAt least one NetworkingPeer should be specified."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='from', type=d.T.array)]),
        withFromMixin(from): { from+: if std.isArray(v=from) then from else [from] },
        '#withPorts':: d.fn(help='"List of ports which should be made accessible on the targets in TargetGroup.\\nIf ports is empty or unspecified, it defaults to all ports with TCP."', args=[d.arg(name='ports', type=d.T.array)]),
        withPorts(ports): { ports: if std.isArray(v=ports) then ports else [ports] },
        '#withPortsMixin':: d.fn(help='"List of ports which should be made accessible on the targets in TargetGroup.\\nIf ports is empty or unspecified, it defaults to all ports with TCP."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ports', type=d.T.array)]),
    ...
    '#withIpAddressType':: d.fn(help='"ipAddressType specifies whether the target group is of type IPv4 or IPv6. If unspecified, it will be automatically inferred."', args=[d.arg(name='ipAddressType', type=d.T.string)]),
    withIpAddressType(ipAddressType): { spec+: { ipAddressType: ipAddressType } },
    '#withMultiClusterTargetGroup':: d.fn(help='"MultiClusterTargetGroup Denotes if the TargetGroup is shared among multiple clusters"', args=[d.arg(name='multiClusterTargetGroup', type=d.T.boolean)]),
    withMultiClusterTargetGroup(multiClusterTargetGroup): { spec+: { multiClusterTargetGroup: multiClusterTargetGroup } },
    ...
    '#withTargetGroupName':: d.fn(help='"targetGroupName is the Name of the TargetGroup."', args=[d.arg(name='targetGroupName', type=d.T.string)]),
    withTargetGroupName(targetGroupName): { spec+: { targetGroupName: targetGroupName } },
    ...
    '#withVpcID':: d.fn(help='"VpcID is the VPC of the TargetGroup. If unspecified, it will be automatically inferred."', args=[d.arg(name='vpcID', type=d.T.string)]),
    withVpcID(vpcID): { spec+: { vpcID: vpcID } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
